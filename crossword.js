...
var allWordsAndDefinitions = {
  words: [],
  definitions: []
};

function addWordToArray(word,definition){
  allWordsAndDefinitions.words.push(word);
  allWordsAndDefinitions.definitions.push(definition);
}
...
function addWordToArrayUsingButton(){
  ...
  if(word && definition){
    ...
    alert('Word and Definition are BOTH required!');
  }
...
var CrosswordUtils = {
    PATH_TO_PNGS_OF_NUMBERS : "images/numbers/",
